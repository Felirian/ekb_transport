  ...
  return (
    <Container>
      <LogoWrapper>
        ...
        <div style={{display: "flex", gap: '230px'}}>
          <P1 data-aos={"fade-right"}>
            Для трамвая разработан логотип, ножка которого ассоциируется с его раздвижной дверью, а дуга
            с колесом поезда
          </P1>
          <P1 data-aos={"fade-left"}>
            Так как основа для логотипов трамваев и троллейбусов одинакова, мы приняли решение сделать для троллейбуса
            логотип, концы линий которого устремлены вверх, символизируя его рога
          </P1>
        </div>
